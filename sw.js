                    ...
                    .then((newData) =>
                      cacheVerData(theUrl, versionChange[setName].old)
                        ...
                        .then((oldData) => {
                          ...
                          newlyAdded[setName].dic = newData;
