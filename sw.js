...
const swVersionConst =  '240fbcb02e927f3c85314ee02666ec3f';
        ...
        return readIndexedDB(db, url)
          ...
          .catch(() => {
            ...
            return fetch(url).then((res) =>
              writeIndexedDB(db, { url, response: res }).then((obj) => {
                return obj.response;
              })
            );
          })
 ...
 * @returns
 */
function writeIndexedDB(db, value) {
