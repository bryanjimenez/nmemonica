            ...
            Promise.all(ps).then(() => {
              if (update) {
                ...
                clients
                  ...
                  .then((client) => {
                    console.log("[SW] msg send " + clients.length);
